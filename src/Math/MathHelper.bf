...
namespace BeefGL
{
    ...
    public static class MathHelper
    {
        ...
        {
            if (n < 0) Runtime.FatalError("Argument n: Must be positive.");
            return (int64)System.Math.Pow(2, System.Math.Ceiling(System.Math.Log((double)n, 2)));
        }
        ...
        {
            const float degToRad = (float)System.Math.PI_f / 180.0f;
        ...
        {
            const float radToDeg = 180.0f / (float)System.Math.PI_f;
        ...
        {
            const double degToRad = System.Math.PI_d / 180.0;
            return degrees * degToRad;
        }
        ...
        {
            const double radToDeg = 180.0 / System.Math.PI_d;
            return radians * radToDeg;
        }
        ...
        public static int32 Clamp(int32 n, int32 min, int32 max)
        {
		...
		public static bool ApproximatelyEqual(float a, float b, int maxDeltaBits) {
			...
			int64 aInt = FloatToint32Bits(a);
			if (aInt < 0)
				aInt = int32.MinValue - aInt;

			int64 bInt = FloatToint32Bits(b);
			if (bInt < 0)
